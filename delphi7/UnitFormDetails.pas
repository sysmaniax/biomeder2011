...
uses UnitFormMain, UnitMiscShared, UnitDataModuleMain;
...
begin
  ...
  QUERY_TYPE_PRODUCTS_TABLE:
    begin
        ...
        // DBEditPrice.Enabled := False;


    end;
  end;
  BMViewerMain.DBGrid1.ReadOnly := True;
  DataModuleMain.ADOQuery1.Edit;
end;
...
begin
  //try
    if DataModuleMain.ADOQuery1.Modified = True then
    begin
      DataModuleMain.ADOQuery1.UpdateRecord;
      DataModuleMain.ADOQuery1.Post;
...
begin
  ...
  begin
    ...
    case iRes of
      ...
      IDNO: begin DataModuleMain.ADOQuery1.CancelUpdates; self.Close; end;
    end; // case
    self.Close;
  end;
  self.Close;
